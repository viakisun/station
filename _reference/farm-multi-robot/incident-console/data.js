/* ============================================================
   ...
   ============================================================ */
(function () {
  const SITE = { id: "SITE-JINJU-01", name: "Jinju Smart-Farm Testbed" };

  const sevMeta = {
    info:{label:"info",sev:"disabled"}, notice:{label:"notice",sev:"notice"},
    warning:{label:"warning",sev:"warning"}, critical:{label:"critical",sev:"critical"}, emergency:{label:"emergency",sev:"emergency"},
  };
  const statusMeta = {
    open:{label:"open",sev:"critical"}, ack:{label:"ack",sev:"warning"},
    progress:{label:"in progress",sev:"notice"}, resolved:{label:"resolved",sev:"normal"}, monitoring:{label:"monitoring",sev:"notice"},
  };
  const srcMeta = {
    robot:{label:"robot",icon:"robot"}, firmware:{label:"firmware",icon:"chip"},
    hmi:{label:"HMI",icon:"hmi"}, telemetry:{label:"Telemetry",icon:"telemetry"}, deploy:{label:"deploy",icon:"rocket"},
  };
  const causeTax = ["comms", "sensor", "actuation", "work params", "firmware", "HMI op", "environment"];

  const incidents = [
    { id: "INC-20260601-0231", sev: "emergency", status: "open", src: "robot", robot: "RBT-THIN-0008", module: "MOD-NAV-N1", code: "NAV-SAFETY-INTERLOCK",
      title: "Safety interlock tripped — e-stop", cause: "actuation", owner: "unassigned", at: "08:51", sla: "00:09", slaBreach: false, recur: 1, impact: "1 session halted", session: "WKS-20260601-00052" },
    { id: "INC-20260601-0229", sev: "critical", status: "progress", src: "robot", robot: "RBT-PINCH-0004", module: "MOD-CAM-V01", code: "CAM-FRAME-DROP",
      title: "Vision frame-drop over threshold", cause: "comms", owner: "Kim H.", at: "08:33", sla: "00:42", slaBreach: false, recur: 4, impact: "1 session blocked", session: "WKS-20260601-00049" },
    { id: "INC-20260601-0226", sev: "critical", status: "open", src: "firmware", robot: "RBT-PINCH-0004", module: "MOD-EE-PINCH", code: "FW-ANALYSIS-BLOCK",
      title: "Firmware static analysis critical — release blocked", cause: "firmware", owner: "unassigned", at: "08:20", sla: "-00:12", slaBreach: true, recur: 2, impact: "release blocked", session: null },
    { id: "INC-20260601-0224", sev: "warning", status: "progress", src: "telemetry", robot: "RBT-THIN-0001", module: "MOD-EE-THIN", code: "EE-FORCE-DRIFT",
      title: "End-effector grip-force drift", cause: "sensor", owner: "Lee J.", at: "08:05", sla: "01:55", slaBreach: false, recur: 3, impact: "possible quality drop", session: "WKS-20260601-00045" },
    { id: "INC-20260601-0218", sev: "warning", status: "ack", src: "robot", robot: "RBT-PINCH-0003", module: "MOD-ARM-A2", code: "ARM-TEMP-HIGH",
      title: "Joint motor temperature rising", cause: "actuation", owner: "unassigned", at: "07:48", sla: "02:12", slaBreach: false, recur: 1, impact: "—", session: "WKS-20260601-00047" },
    { id: "INC-20260601-0212", sev: "warning", status: "monitoring", src: "telemetry", robot: "RBT-THIN-0001", module: "MOD-CAM-V01", code: "TEL-DATA-GAP",
      title: "Vision FPS data gap 12%", cause: "comms", owner: "Lee J.", at: "07:32", sla: "—", slaBreach: false, recur: 5, impact: "quality metric gap", session: null },
    { id: "INC-20260601-0205", sev: "notice", status: "resolved", src: "hmi", robot: "RBT-THIN-0005", module: "MOD-NAV-N1", code: "NAV-RELOCALIZE",
      title: "Navigation relocalization occurred", cause: "environment", owner: "Lee J.", at: "07:20", sla: "—", slaBreach: false, recur: 1, impact: "—", session: "WKS-20260601-00050" },
    { id: "INC-20260531-0198", sev: "critical", status: "resolved", src: "hmi", robot: "RBT-PINCH-0003", module: "MOD-EE-PINCH", code: "HMI-CALIB-FAIL",
      title: "Calibration verification failed", cause: "HMI op", owner: "Kim H.", at: "yest 18:40", sla: "—", slaBreach: false, recur: 2, impact: "work delayed", session: null },
  ];
  ...
  const laneMeta = {
    work:{label:"work",icon:"board"}, command:{label:"command",icon:"terminal"},
    telemetry:{label:"Telemetry",icon:"telemetry"}, hmi:{label:"HMI op",icon:"hmi"}, firmware:{label:"firmware",icon:"chip"},
  };
  ...
  // C03-08 리포트 metrics
  const report = {
    mttr: "42m", mtbf: "18.4h", total: 31, resolved: 24, recurRate: 22,
    trend: [4, 6, 3, 7, 5, 8, 6],
    pareto: [
  ...
  window.IC = {
    SITE, sevMeta, statusMeta, srcMeta, causeTax, incidents,
    streamSeed, streamIncoming, timeline, laneMeta, actionGuide, report,
