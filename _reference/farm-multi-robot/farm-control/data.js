/* ============================================================
   Mock SSOT 데이터 — Jinju Smart-Farm Testbed
...
(function () {
  ...
  const moduleMeta = {
    unknown:{label:"unknown",sev:"disabled"}, disconnected:{label:"disconnected",sev:"disabled"},
    initializing:{label:"initializing",sev:"notice"}, normal:{label:"normal",sev:"normal"},
    warning:{label:"warning",sev:"warning"}, degraded:{label:"degraded",sev:"warning"},
    fault:{label:"fault",sev:"critical"}, maintenance:{label:"maintenance",sev:"notice"},
    disabled:{label:"disabled",sev:"disabled"},
  };

  const sevMeta = {
    info:{label:"info",sev:"disabled"}, notice:{label:"notice",sev:"notice"},
    warning:{label:"warning",sev:"warning"}, critical:{label:"critical",sev:"critical"},
  ...
  window.MOCK = {
    SITE, greenhouses, robots, robotStateMeta, workMeta, sessions, modules, moduleMeta,
    sevMeta, incidents, events, maps, workplan, telemetry, commands,
    kpi: {
      robotsOnline: 7, robotsTotal: 10,
      working: 3, incidentsOpen: 4, incidentsCritical: 2,
      deploys: 1, telemetryQuality: 96.4, sessionsActive: 6,
    },
  };
})();
