/* ============================================================
   현장 HMI 커미셔닝 콘솔 — Mock 데이터
   이기종 로봇/모듈/현장환경 · plug&play 아님 (식별→선택→compatible매칭→연결)
   ============================================================ */
(function () {
  const robot = {
    id: "RBT-THIN-0011", type: "thin", model: "HV-Thinner X2", serial: "HX2-2026-0211",
    hmi: "HMI-FIELD-07", controller: "CTRL v3.2", power: 82,
  };
  ...
  const protocolDefaults = {
    ...
    qos: 1, ack: "at_least_once", timeout: 500, security: "TLS · X.509",
  };
  ...
  window.HM = {
    robot, sites, devKey, catalog, nodes, detectMeta, versions, verMeta,
    transports, protocolDefaults, steps,
