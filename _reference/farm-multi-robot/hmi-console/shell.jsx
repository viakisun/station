...
const HMI_W = 1024, HMI_H = 768, BEZEL = 26;

function HmiFrame({ children }) {
  const ref = useRef(null);
  useEffect(() => {
    const fit = () => {
      const totalW = HMI_W + BEZEL * 2, totalH = HMI_H + BEZEL * 2;
...
function HmiStatusBar({ robot, title, connected, registered, safety }) {
...
Object.assign(window, { HmiFrame, HmiStatusBar, TouchBtn, HMI_W, HMI_H });
