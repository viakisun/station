/* ============================================================
   Telemetry 설정 콘솔 — Mock 데이터
   원천 신호 → 표준 TelemetryChannel 매핑 · 캘리브 · 정책 · 품질
   ============================================================ */
(function () {
  const device = {
    id: "TEL-GW-A-07", model: "EdgeGateway v2", robot: "RBT-THIN-0011",
    site: "Greenhouse A", fw: "2.1.4", uplink: "MQTT · tls", power: "PoE",
  };
  ...
  // 센서 캘리브레이션 대상
  const calibrations = [
    { ch: "TCH-gh-temp",       label: "GH temperature",  raw: 24.95, cal: 24.61, zero: 0.0,  span: 1.0, offset: -0.34, scale: 1.000, due: false },
    { ch: "TCH-gh-humidity",   label: "GH humidity",  raw: 70.2,  cal: 68.4,  zero: 0.0,  span: 1.0, offset: -1.8,  scale: 1.000, due: true },
    { ch: "TCH-ee-grip-force", label: "Grip force",     raw: 13.1,  cal: 12.4,  zero: 0.2,  span: 0.98,offset: 0.0,   scale: 0.980, due: false },
    { ch: "TCH-arm-joint-temp",label: "Joint temp",  raw: 58.9,  cal: 58.2,  zero: 0.0,  span: 1.0, offset: -0.7,  scale: 1.000, due: false },
  ];
  ...
  // 데이터 품질 진단
  const qualityMeta = {
    good: { label: "good", sev: "normal" }, warn: { label: "warning", sev: "warning" }, bad: { label: "bad", sev: "critical" },
  };
  const quality = [
  ...
  window.TM = {
    device, rawSignals, channels, calibrations, policies, quality, qualityMeta, steps,
    kpi: {
      channelsTotal: 9, channelsMapped: 6, quality: 96.3, latency: 188,
      buffer: 12, syncState: "live", devicesOnline: 4,
    },
  };
})();
